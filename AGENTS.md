...
Documentation is written **ahead of** the code it specifies, and no zone has a page cap — the specifications drive implementation, so a missing page is work outstanding rather than a decision ([ADR-0036](./docs/decisions/0036-write-the-specifications-before-the-code.md)).
