...
| First publish             | **manual**, with a scoped `publish-new` token; gated on working passthrough ([ADR-0022](./docs/decisions/0022-cut-the-first-release-when-passthrough-works.md)) | Trusted Publishing is configured against an already-existing crate                                                                                                       |
