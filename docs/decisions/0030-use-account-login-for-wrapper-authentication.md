...
Claiming `auth` would otherwise force native callers through `--`, contrary to [ADR-0002](./0002-verbatim-argv-passthrough.md) and the small surface in [ADR-0003](./0003-reserve-a-small-wrapper-cli-surface.md). See [ADR-0021](./0021-fail-closed-without-a-terminal.md).
