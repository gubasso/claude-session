...
- Good: the taxonomy answers design questions instead of vetoing them.
...
Amends [ADR-0005](./0005-exit-code-taxonomy.md) — the split at the spawn and the exhaustive no-catch-all mapping are unchanged; only the stability rule changes.
