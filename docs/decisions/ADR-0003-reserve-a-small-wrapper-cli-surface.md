...
Amended by [ADR-0015](./ADR-0015-retire-the-init-verb.md) (`init` leaves the claimed verb set), [ADR-0016](./ADR-0016-ship-man-pages.md) (`man` joins it), [ADR-0043](./ADR-0043-match-wrapper-flags-by-exact-leading-spelling.md) (how a token is recognized as claimed), [ADR-0044](./ADR-0044-audit-wrapper-spellings-against-the-child-inventory.md) (`-v` leaves the set, and collisions are audited rather than recorded), and [ADR-0045](./ADR-0045-compose-doctor-with-the-child-report.md) (a verb may keep a colliding name when it composes with the child's).
