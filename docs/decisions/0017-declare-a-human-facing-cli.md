...
Amended by [ADR-0024](./0024-machine-output-is-a-per-verb-flag.md), which settles the flag's spelling and placement as a verb-level `--json`. The opt-in decision recorded here is unchanged.
