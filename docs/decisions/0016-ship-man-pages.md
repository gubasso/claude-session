...
Man pages describe the **wrapper's** grammar only, for the reason [ADR-0002](./0002-verbatim-argv-passthrough.md) gives: the child's flag list is not the wrapper's to track, and a stale copy of it would be worse than none.
...
Amends [ADR-0003](./0003-reserve-a-small-wrapper-cli-surface.md) — the claimed verb set grows by one.
