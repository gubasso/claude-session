...
Workflow consumption is implemented, while forge setup remains manual. This record does not amend [ADR-0020](./0020-adopt-a-two-branch-release-model.md); it implements that record's credential consequence.
