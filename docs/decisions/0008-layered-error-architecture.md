...
- Good: a caller can match on what went wrong instead of inspecting a message.
...
- Bad: the no-boxed-error rule occasionally makes an internal signature more verbose.
