...
The first version remains the one-time manual exception required by [ADR-0022](./0022-cut-the-first-release-when-passthrough-works.md). See [the release workflow](../reference/release-workflow.md) for the contract and [the release guide](../guides/releasing.md) for procedures.
...
This record formalizes an unrecorded tool and authentication choice. It neither supersedes nor amends another ADR and is consistent with ADR-0022 and [ADR-0023](./0023-only-release-automation-opens-pull-requests.md).
