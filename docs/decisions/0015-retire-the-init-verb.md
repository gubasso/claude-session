...
`init` was specified to create the wrapper's configuration scaffold. [ADR-0013](./0013-generate-config-examples-from-types.md) removes that job: users copy a generated example instead. The question left is whether the verb survives with a narrower purpose or goes.
...
Amends [ADR-0003](./0003-reserve-a-small-wrapper-cli-surface.md) — the claimed verb set shrinks by one.
