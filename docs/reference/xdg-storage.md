...
| Peer registry link       | State  | `.../sessions/<namespace>/<terminal>/sessions`        | Session subsystem                                    | Link; the kernel's own         | Until account removal                 |
