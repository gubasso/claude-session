...
The `doctor` verb, its report, `--list`, and `--strict` are implemented over 18 checks.
...
Summary
  ...
  18 checks: 12 passed, 1 warning, 5 not applicable.
...
```json
{
  ...
  "wrapper": {
    ...
    "summary": { "total": 18, "passed": 18, "warned": 0, "failed": 0, "skipped": 0, "hard_failures": 0, "exit": 0 }
  },
