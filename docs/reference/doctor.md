...
| `session-terminal-derives`  | Session | Hard     | `Unavailable`        | A terminal or a session leader named the directory this run's child state belongs in                           | The terminal this session belongs to     |
