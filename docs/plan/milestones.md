...
- 039 cross-container-session-lookup — done — 2 implementation sessions — after 037; a report names a session from that session's own registry rather than only this run's
