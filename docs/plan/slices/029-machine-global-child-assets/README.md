...
2026-08-21: the acceptance line about an occupant already sitting at an asset name was removed, superseded by [036](../036-agent-keyed-sessions/README.md). A session directory is now created for one agent run and nothing can have reached a name inside it first. The seat is still validated, and [Q-014](../../open-questions.md#q-014--which-launch-path-guards-survive-a-directory-that-is-always-fresh) owns whether that stays.
